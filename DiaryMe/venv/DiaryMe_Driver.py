...
<head>
	...
	<meta name="viewport" content="width=divice-width, inintial-scale=1">
...
def main():
    ...
    for i in range(100):
        if os.path.isfile(f'DiaryMe{i}.html') == False:
            out_file = open(f'DairyMe{i}.html', 'w', encoding='utf-8')
            file_number = i
            break
        else:
            i += 1

    filename= 'DiaryMe' + str(file_number)
    attemps_html = ""
    return 0
